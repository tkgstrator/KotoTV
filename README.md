...
| ブラウザ | バージョン | 備考 |
|---------|-----------|------|
| iOS Safari | 16 以降 | 主要ターゲット。HEVC 再生対応 |
| Android Chrome | 最新版 | 主要ターゲット。VP9 再生対応 |
| Chrome / Edge (PC) | 最新版 | 動作確認対象 |
...
- 現時点では Phase 2（ライブ HLS ストリーミング）が進行中で、録画・EPG などはまだ実装されていない機能もあります。
