...
私たちが当たり前に利用している Netflix や AbemaTV では、アプリを開いた瞬間に映像が流れ始めます。KotoTV はこの体験を、地上波・BS・CS のテレビ放送にも持ち込みたいと考えています。
...
- **将来のリモコン操作を最初から織り込むこと** ── いずれ tvOS や FireTV への移植を見据えており、DOM の並び順と focus ring は今のうちから整えておきたいのです。リモコン対応を後から「貼り付ける」のはあまりにも高コストであり、現実的ではないというのが筆者の立場です。
